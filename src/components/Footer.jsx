    ...
    <footer className="relative w-full bg-[#050508] pt-32 pb-10 px-6 md:px-10 border-t border-white/5 z-50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-24">
          ...
          <div className="col-span-1 md:col-span-6 flex flex-col items-start">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-2xl font-heading font-bold tracking-widest text-white">M. ZAIN</span>
            </div>
            <p className="text-gray-400 max-w-sm text-lg leading-relaxed mb-8">
              Crafting high-performance digital experiences that merge cinematic storytelling with cutting-edge technology.
            </p>
            
            <a href="mailto:hello@mzain.com" className="group flex items-center space-x-3 text-white font-medium hover:text-blue-400 transition-colors">
          ...
          <div className="col-span-1 md:col-span-3 flex flex-col space-y-4">
            ...
            {['Home', 'About', 'Services', 'Portfolio', 'Contact'].map((item) => (
              <a key={item} href={`/${item.toLowerCase() === 'home' ? '' : item.toLowerCase()}`} className="text-gray-400 hover:text-blue-400 transition-colors w-max text-sm uppercase tracking-wider">
                {item}
              </a>
            ))}
          </div>
          ...
          <div className="col-span-1 md:col-span-3 flex flex-col space-y-4">
            ...
            {['LinkedIn', 'Twitter / X', 'Instagram', 'YouTube'].map((item) => (
              <a key={item} href="#" className="text-gray-400 hover:text-blue-400 transition-colors w-max text-sm uppercase tracking-wider">
                {item}
              </a>
            ))}
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} M. ZAIN. All rights reserved.</p>
          ...
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            ...
            <button 
              onClick={scrollToTop}
              className="ml-4 flex items-center space-x-2 text-white hover:text-blue-400 transition-colors group"
            >
