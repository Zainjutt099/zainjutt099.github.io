        ...
        <div className="flex flex-col space-y-12">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <a href="mailto:zainjutt0167@gmail.com" className="group flex items-center space-x-6">
              <div className="w-14 h-14 rounded-full bg-[#050508] border border-white/10 flex items-center justify-center group-hover:bg-blue-500/10 group-hover:border-blue-500/30 transition-all flex-shrink-0">
              ...
              <div className="overflow-hidden">
                ...
                <p className="text-white font-medium text-lg group-hover:text-blue-400 transition-colors truncate">zainjutt0167@gmail.com</p>
              </div>
            </a>

            {/* LinkedIn Link (Added Separately) */}
            <a href="https://www.linkedin.com/in/zain-jutt-094618241/" target="_blank" rel="noopener noreferrer" className="group flex items-center space-x-6">
              <div className="w-14 h-14 rounded-full bg-[#050508] border border-white/10 flex items-center justify-center group-hover:bg-blue-500/10 group-hover:border-blue-500/30 transition-all flex-shrink-0">
              ...
              <div className="overflow-hidden">
                ...
                <p className="text-white font-medium text-lg group-hover:text-blue-400 transition-colors truncate">linkedin.com/in/zain-jutt...</p>
              </div>
            </a>
            ...
            <a href="#" className="group flex items-center space-x-6">
              ...
              <div className="overflow-hidden">
                ...
                <p className="text-white font-medium text-lg group-hover:text-blue-400 transition-colors truncate">Remote / Worldwide</p>
              </div>
            </a>
          </div>
        </div>
